...
```typescript
import { Recorder } from '@scheduler-systems/demo-studio';
...
```typescript
import { WindowDetector } from '@scheduler-systems/demo-studio';
...
```typescript
import { ScreenCapture } from '@scheduler-systems/demo-studio';
...
```typescript
import { ZoomEngine } from '@scheduler-systems/demo-studio';
...
```typescript
import { CursorEngine } from '@scheduler-systems/demo-studio';
...
```typescript
import { OverlayEngine } from '@scheduler-systems/demo-studio';
...
```typescript
import { TimelineEditor } from '@scheduler-systems/demo-studio';
...
```typescript
import { Renderer } from '@scheduler-systems/demo-studio';
...
```typescript
import { TTSEngine } from '@scheduler-systems/demo-studio';
