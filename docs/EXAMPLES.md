...
```typescript
import { Recorder, ZoomEngine, Renderer, TimelineEditor } from '@scheduler-systems/demo-studio';
...
```typescript
import { WindowDetector, Recorder } from '@scheduler-systems/demo-studio';
